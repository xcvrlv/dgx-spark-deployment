...
"""
    ...
    def test_sparkrun_glm53_exl3_recipe_uses_decode_only_graphs(self) -> None:
        ...
        self.assertIn('kv_cache_memory_bytes: 18000000000', recipe)
        ...
        self.assertIn('"cudagraph_capture_sizes":[1,5,10,15,20,25,30,35,40]', recipe)
        self.assertNotIn("FULL_AND_PIECEWISE", recipe)
        self.assertIn('\\"method\\":\\"mtp\\"', recipe)
        self.assertIn('\\"num_speculative_tokens\\":4', recipe)
        ...
        self.assertIn("VLLM_B12X_MLA_CKV_GATHER: \"0\"", recipe)
        ...
        self.assertIn("--no-async-scheduling", recipe)
        self.assertIn('B12X_MOE_FORCE_A8: "0"', recipe)
        self.assertIn('B12X_MOE_FORCE_A16: "1"', recipe)
