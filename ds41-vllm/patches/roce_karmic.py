...
Rebased on b12x a7d7d29 (master, checked 2026-09-25). The local port only
changes transport initialization/proxy. All four switches default off in code
and are selected by the serving recipe.
"""
import argparse
import hashlib
...
INPUTS = {'comm/roce/_roce_proxy.c': '81a21aab6a202a86a8a2cbc4fec727506bfb738759eb6d854c50c0c9a9121b64', 'comm/roce/roce_oneshot.py': '572429e67e0cd63c04854797fe6c27eca0ec1afe4ab24fc2b4e7f971f67e7f01'}
OUTPUTS = {'comm/roce/_roce_proxy.c': 'ec54c91b721366ab8f4ab47759e5c9863a446041278d0c7bf6dd81051ebf99c3', 'comm/roce/roce_oneshot.py': '715c1075ffa60ddbdd185ea00775102a2a070296fcbcda6f8a9171f1c44d9f2a'}
