...
ARG CHECK_SHA
COPY patches/roce_dtype.py patches/roce_programs.py patches/b12x_tuning.py /opt/ds41/patches/
...
LABEL local-inference.roce-dtype="v1" local-inference.roce-programs="v1" local-inference.b12x-tuning="v1"
DOCKERFILE
