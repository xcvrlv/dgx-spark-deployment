...
def test_immutable_arm64_source_composition() -> None:
    ...
    for identity in (
        ...
        "1c02d95c3d5294d9ee4b43875e3d7e84c3739c0a",
    ...
    assert (
        'local-inference.vllm.composed.tree="1c02d95c3d5294d9ee4b43875e3d7e84c3739c0a"'
        in DOCKERFILE
    )
...
def test_four_spark_mtp3_runtime_contract() -> None:
    ...
    required = (
        ...
        "container: spark-vllm-glm53-exl3:r22-dflash2-sm121-v7",
        "min_nodes: 4",
        "max_nodes: 4",
        "tensor_parallel: 4",
...
def test_cluster_image_distribution_is_identity_checked() -> None:
    ...
    assert "r22-dflash2-sm121-v7" in BUILDER
