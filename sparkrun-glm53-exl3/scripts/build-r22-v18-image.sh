...
GLM53_R22_IMAGE="${GLM53_R22_IMAGE:-spark-vllm-glm53-exl3:r22-dflash2-sm121-v18}" \
GLM53_R22_DOCKERFILE="$context/Dockerfile.r22-dflash2-v18" \
GLM53_R22_V16_SMOKE=1 GLM53_R22_SMOKE_SCRIPT=smoke_r22_v18.py \
