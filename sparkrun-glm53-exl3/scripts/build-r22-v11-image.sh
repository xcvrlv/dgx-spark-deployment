#!/usr/bin/env bash
# Build the preserved v10 base, then build, check and distribute v11.
set -euo pipefail
if (( $# != 3 )); then
...
GLM53_R22_IMAGE="${GLM53_R22_IMAGE:-spark-vllm-glm53-exl3:r22-dflash2-sm121-v11}" \
GLM53_R22_DOCKERFILE="$context/Dockerfile.r22-dflash2-v11" \
GLM53_R22_V11_SMOKE=1 \
