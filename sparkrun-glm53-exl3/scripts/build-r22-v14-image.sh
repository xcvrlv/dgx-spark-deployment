...
GLM53_R22_IMAGE="${GLM53_R22_IMAGE:-spark-vllm-glm53-exl3:r22-dflash2-sm121-v14}" \
GLM53_R22_DOCKERFILE="$context/Dockerfile.r22-dflash2-v14" \
GLM53_R22_V12_SMOKE=1 GLM53_R22_V14_SMOKE=1 \
